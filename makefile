...
TARGET = threads-sincro-charla3 # Definimos la tarea que va a ejecutar make por defecto Y el nombre del binario final
LIBS = -lpthread # Incluimos las bibliotecas que necesitamos, las commons y readline
